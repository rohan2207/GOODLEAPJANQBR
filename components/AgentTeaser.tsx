...
export default function AgentTeaser() {
    return (
        <section className="relative w-full py-24 md:py-40 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1100px] h-[650px] bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-orange-500/10 blur-[150px] rounded-full" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center">
                ...
                >
                    <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/[0.03] border border-white/[0.06]">
                        ...
                        <span className="text-sm text-white/60 font-body font-medium uppercase tracking-[0.15em]">Introducing AI-Powered Assistants</span>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        {/* Dashboard Content */}
                        <div className="flex min-h-[550px] md:min-h-[620px]">
                            ...
                            {/* Main Content Area */}
                            <div className="flex-1 p-8 md:p-10 flex flex-col justify-center bg-gradient-to-br from-[#0f0f12] to-[#13131a]">
                                <motion.div
                                ...
                                >
                                    {/* Dashboard Header */}
                                    <div className="mb-8">
                                        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 mb-5">
                                            <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
                                            <span className="text-xs text-orange-400 font-medium uppercase tracking-wider">AI Agent</span>
                                        </div>
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-display font-medium text-white/90 mb-4 leading-tight">
                                        ...
                                        <p className="text-base md:text-lg text-white/40 max-w-lg font-body font-light leading-relaxed">
                            ...
                            {/* AI Sidebar */}
                            <motion.div 
                                className="w-80 md:w-96 bg-white border-l border-gray-100 flex flex-col"
                                ...
                                <div className="bg-white px-5 py-4 border-b border-gray-50 space-y-4">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-100 rounded-lg text-sm text-gray-600 placeholder:text-gray-400 focus:outline-none"
                                            readOnly
                                        />
                                    </div>
                                    <div className="flex items-center gap-2.5">
                    ...
                    <div className="absolute -inset-10 bg-gradient-to-r from-purple-500/20 via-blue-500/15 to-orange-500/20 blur-3xl -z-10 rounded-3xl opacity-60" />
                </motion.div>
                ...
                >
                    <span className="text-xs text-white/20 uppercase tracking-[0.3em] font-body">See it in action</span>
...
function AgentItem({ icon: Icon, color, title, description, delay }: { icon: any; color: string; title: string; description: string; delay: number }) {
    return (
        ...
        >
            <div className={`w-11 h-11 rounded-lg ${color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}>
